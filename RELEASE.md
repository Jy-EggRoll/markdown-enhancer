...
Push a development tag like `0.0.1.dev.1`, or run the `Package Extension` workflow manually. Development packages are uploaded to GitHub artifacts/releases only and are not published to the Marketplace.
